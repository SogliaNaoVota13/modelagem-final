...
app.get('/produto/:nome', produtoController.listarProduto)
app.get('/produto/:id', produtoController.listarProdutoPorID)
app.put('/produto/:id', produtoController.atualizarProduto)
app.delete('/produto/:id', produtoController.apagarProduto)

//Controller Compra
app.post('/compra', compraController.cadastrarCompra)
app.get('/compra', compraController.listarCompra)
app.get('/compra/:id', compraController.listarCompraPorID)
app.put('/compra/:id', compraController.atualizarCompra)
app.delete('/compra/:id', compraController.apagarCompra)
